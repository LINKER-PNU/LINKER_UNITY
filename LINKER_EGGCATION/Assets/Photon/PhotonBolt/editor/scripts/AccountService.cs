...
namespace Photon.Bolt.Utils
{
	...
	public class AccountService
	{
				...
				Action<string> errorCallback = null)
		{
			...
			return RegisterByEmail(req, callback, errorCallback);
		}
				...
				Action<AccountServiceResponse> callback = null, Action<string> errorCallback = null)
		{
			...
			return RegisterByEmail(email, GetServiceTypesFromList(serviceTypes), callback, errorCallback);
		}
		...
		{
			var email = UnityWebRequest.EscapeURL(request.Email);
			var st = UnityWebRequest.EscapeURL(request.ServiceTypes);
